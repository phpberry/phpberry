...
<title><?php echo $current=="index" ? "Home" : $title ; ?> | <?php echo $company; ?></title>
    <?php if(!$seo){ ?> <META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW"> <?php } ?>
    ...
    <?php if( $jsmsg ){ ?>
        <noscript>
            ...
            <center>
                ...
                " Please enable JavaScript in your browser <br>OR<br> upgrade to a JavaScript-capable browser to visit for <?php echo $company; ?>. "
            </center>
            </div>
        </noscript>
    <?php  } ?>       